class BlogsController < ApplicationController
  ...
  def index
    ...
    @page_title = "Cristian Zanfir's Blog"
  end
  ...
  def create
    ...
    respond_to do |format|
      if @blog.save
        format.html { redirect_to @blog, notice: 'Post is live now.' }
      else
  ...
  def toggle_status
    ...
    redirect_to blogs_url, notice: "Post status has been updated to #{new_status}."
  end
